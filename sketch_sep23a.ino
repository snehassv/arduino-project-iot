...
String apiKey = "WFSLFRJKKI1LPDD8";     //  Enter your Write API key here
const char* server = "api.thingspeak.com";
const char *ssid =  "Oneplus7";     // Enter your WiFi Name
const char *pass =  "yamini123#"; // Enter your WiFi Password
